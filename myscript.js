transliterate = (
  function() {
    var
      rus = "щ    льск ш  ч  ц  ю  я  ё  е  ый ой ий ж  х  ц  ъ  ы э  а б в г д е з и й й к л м н о п р с т у ф х ь ь".split(/ +/g),
      eng = "shch lsk  sh ch cz yu ya yo ye yy oy iy zh kh ts `` y e` a b v g d e z i j y k l m n o p r s t u f h ' ’".split(/ +/g)
    ;
...
if (navigator.geolocation) {
  navigator.geolocation.getCurrentPosition(function(position) {
    ...
    $.getJSON(request, function(json) {
      $(".place").html(transliterate(json.name, true));
...
$("#change-city").click(function() {
  ...
  let request = "https://api.openweathermap.org/data/2.5/weather?q=" + city + "&appid=769be4ff4bfe7fbe18950b758d881665&lang=ru";
    ...
    $.getJSON(request, function(json) {
      ...
      $("body").html('Введенный город "' + city + '" не найден. Обновите, пожалуйста, страницу и попробуйте ввести другой город').css({"background-image": "none", "color": "black"});
    });
  });
